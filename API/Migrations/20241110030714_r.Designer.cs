...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.FinishedCourses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Entities.Registered", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Entities.LectSect", b =>
                {
                    ...
                    b.HasOne("API.Entities.Room", "RoomL")
                        .WithMany()
                        .HasForeignKey("RoomLId");
            ...
            modelBuilder.Entity("API.Entities.Registered", b =>
                {
                    ...
                    b.HasOne("API.Entities.LectSect", "Lectsec")
                        .WithMany()
                        .HasForeignKey("LectsecId");
